...
\subsubsection{考察2.1}
実験結果より500\,Hzでは出力振幅が入力より小さく、
位相も完全には一致していない。1\,kHzでは入力と出力の振幅がほぼ等しくなり、
位相差もほとんどなくなっている。2\,kHzでは再び出力振幅が小さくなり、入力に対して位相のずれが見られる。

ウィーンブリッジ発振回路が発振するためには、帰還回路を通って戻る信号が元の信号を打ち消さない位相であり、さらに一巡した後の利得が1になる必要がある。今回の結果では、
1\,kHz付近で出力が入力とほぼ同じ振幅・同位相となっているため、この周波数で帰還回路の位相条件が満たされ、
発振条件に近い状態になっていると考えられる。一方、500\,Hzや2\,kHzでは利得が1からずれ、位相差も生じているため、
発振条件を満たしにくい。
